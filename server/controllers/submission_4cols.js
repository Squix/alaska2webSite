...
/*    for (let i = 0; i < correctAns.length; i++) {
    ...
    */
    ...
    for (let i = 0; i < correctAns.length; i++) {
      if (mask[i] === 1) {
	console.log(`IDX1 = %d, mask=%d \t correctAns=%c`, i, mask[i], correctAns[i])
...
/*  for (let i = 0; i < correctAns.length; i++) {
    ...
    */
    ...
    let nbFA = 0.0
      ...
      console.log(`datasetSize = %d`, datasetSize)
      console.log(`nbStego = %d`, nbStego)
      console.log(`nbCover = %d`, nbCover)
//      console.log(`nbSteg = %d`, nbSteg)
//      console.log(`nbCov = %d`, nbCov)
      console.log(`nbMD = %d`, nbMD)
      console.log(`nbFA = %d`, nbFA)
    ...
    for (let i = 0; i < correctAns.length; i++) {
      ...
      console.log(`UserRep=%d \t TrueStatus=%d\t nbFA = %d \t nbMD = %d \t MASK=%d \t i= %d \t datasetIndex =%d`, ans[i]-1 , correctAns[ans[i]-1] , nbFA, nbMD, mask[i], i, datasetIndex)
...
//      top10: Math.round(TOP10FA*10000)/100
    })
